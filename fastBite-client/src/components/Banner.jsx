            ...
            <div className='py-24 flex flex-col md:flex-row justify-between items-center gap-8'>
                ...
                <div className='md:w-1/2'>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-around -mt-1 gap-6'>
                        <div className='flex bg-white py-2 px-3 items-center gap-3 shadow-md w-64 rounded-2xl'>
                            <img src="/images/home/b-food1.jpg" alt="" className='w-24 h-24 rounded-2xl' />
                            <div className='space-y-1'>
                                <h5 className='font-medium mb-1'>Cheese Burger</h5>
                        ...
                        <div className='sm:flex hidden bg-white py-2 px-3 items-center gap-3 shadow-md w-64 rounded-2xl'>
                            <img src="/images/home/b-food1.jpg" alt="" className='w-24 h-24 rounded-2xl' />
                            <div className='space-y-1'>
                                <h5 className='font-medium mb-1'>Cheese Burger</h5>
                                <div className="rating rating-sm">
